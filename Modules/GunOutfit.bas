...
Sub Data()
    ...
    Set startDataCell = ThisWorkbook.Worksheets("Guns").range("B3")
    
    Dim heading As Variant
    heading = sf.getHeadingArray("Guns", "C2")
    ...
    For pathNum = LBound(path) To UBound(path)
        ...
        For lineNum = LBound(txtLine) To UBound(txtLine)
            ...
            If InStr(1, txtLine(lineNum), "outfit") = 1 Then
                ...
                ThisWorkbook.Worksheets("Guns").range(startDataCell.Offset(offsetY, 0).Address & ":" & startDataCell.Offset(offsetY, UBound(heading)).Address).ClearContents
                ...
                While InStr(1, txtLine(lineNum), vbTab) = 1
                    ...
                    ElseIf InStr(1, txtLine(lineNum), "category ""Guns""") = 2 Then
    ...
    MsgBox ("Gun outfit data imported")
End Sub
