Attribute VB_Name = "EngineOutfit"
Option Explicit
...
Sub Data()
    ...
    Set startDataCell = ThisWorkbook.Worksheets("Engines").range("B3")
    
    Dim heading As Variant
    heading = sf.getHeadingArray("Engines", "C2")
    ...
    For pathNum = LBound(path) To UBound(path)
        ...
        For lineNum = LBound(txtLine) To UBound(txtLine)
            ...
            If InStr(1, txtLine(lineNum), "outfit") = 1 Then
                ...
                ThisWorkbook.Worksheets("Engines").range(startDataCell.Offset(offsetY, 0).Address & ":" & startDataCell.Offset(offsetY, UBound(heading)).Address).ClearContents
                ...
                While InStr(1, txtLine(lineNum), Chr(9)) = 1
                    ...
                    ElseIf InStr(1, txtLine(lineNum), "category ""Engines""") = 2 Then
    ...
    MsgBox ("Engine outfit data imported")
End Sub
